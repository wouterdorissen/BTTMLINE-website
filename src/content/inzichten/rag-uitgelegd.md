---
title: RAG uitgelegd zonder jargon
category: Demystifying AI
summary: Hoe je een model laat antwoorden op basis van jouw documenten.
date: 2026-03-20
readingTime: 4 min
---
...
1. **Klaarzetten.** Je documenten worden in stukjes gehakt en opgeslagen op een manier die zoeken op betekenis mogelijk maakt.
2. **Ophalen.** Bij een vraag zoekt het systeem de paar stukjes op die er echt toe doen.
3. **Antwoorden.** Alleen die relevante stukjes gaan mee naar het model, samen met de vraag. Het model antwoordt op basis van jouw tekst, niet op basis van een vaag geheugen.
